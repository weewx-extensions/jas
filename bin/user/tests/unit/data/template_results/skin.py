...
'''
result_index_build_navigation_language = \
'''
                  ...
                  <ul class="navbar-nav me-auto mb-2 mb-md-0 navbar-nav-scroll">
                        <li class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdownLanguage" id="dropdownLanguageMenu">
                            <a class="dropdown-item" id="lang-1" data-bs-toggle="collapse" data-bs-target=".navbar-collapse" role="button" onclick="updateLang('lang-1')">Translated label (lang-1)</a>
                            <a class="dropdown-item" id="lang-2" data-bs-toggle="collapse" data-bs-target=".navbar-collapse" role="button" onclick="updateLang('lang-2')">Translated label (lang-2)</a>
                           </div>
                        </li>
                  </ul>
                  <div class="form-check form-switch">
